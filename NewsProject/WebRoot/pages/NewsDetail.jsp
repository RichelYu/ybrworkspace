...
<div class="nav-navicon admin-main admin-sidebar">
    ...
    <div class="sideMenu">
      ...
      <h3 class="am-icon-gears"><em></em> <a href="#">个人信息</a></h3>
...
<div class="admin-biaogelist">
    ...
    <div class="listbiaoti am-cf">
      <ul class="am-icon-flag on">新闻详情</ul>
      
      <dl class="am-icon-home" style="float: right;"> 当前位置： <a href="#">首页</a> > <a href="#">新闻列表</a>>新闻详情</dl>
    ...
    <div class="fbneirong">
      <form class="am-form" action="${pageContext.request.contextPath }/admin/addNews"  enctype="multipart/form-data"
        ...
        <div class="am-form-group am-cf">
          ...
          <div class="you">
            <input type="text" class="am-input-sm" value="${news.id }" readonly="readonly" name="id" placeholder="请输入标题">
          </div>
        </div>
        <div class="am-form-group am-cf">
          <div class="zuo">标题：</div>
          <div class="you">
            <input type="text" class="am-input-sm" value="${news.title }" readonly="readonly" placeholder="请输入标题">
          </div>
        </div>
        <div class="am-form-group am-cf">
          <div class="zuo">内容：</div>
          <div class="you">
            <input type="text" class="" name="content" rows="3" readonly="readonly" id="doc-ta-1" value="${news.content }">
          </div>
        </div>
    	...
    	<div class="am-form-group am-cf">
          ...
          <div class="you" style="height: 45px;">
            <input type="text"   value="${author}" readonly="readonly">
          </div>
        </div>
        ...
        <div class="am-form-group am-cf">
          ...
          <div class="you" style="height: 45px;">
            <a href="${pageContext.request.contextPath }/${news.img}">${news.img}</a>
          </div>
        </div>
		...
		<input type="text"   value="财经" readonly="readonly">
		</c:when>
		<c:when test="${news.type==1 }">
		<input type="text"   value="社会" readonly="readonly">
		</c:when>
		<c:when test="${news.type==2 }">
		<input type="text"   value="军事" readonly="readonly">
		</c:when>
		<c:when test="${news.type==3 }">
		<input type="text"   value="历史文化" readonly="readonly">
		</c:when>
		<c:when test="${news.type==4 }">
		<input type="text"   value="科技" readonly="readonly">
		</c:when>
		<c:when test="${news.type==5 }">
		<input type="text"   value="汽车" readonly="readonly">
		</c:when>
		<c:when test="${news.type==6 }">
		<input type="text"   value="房产" readonly="readonly">
		</c:when>
		<c:when test="${news.type==7 }">
		<input type="text"   value="体育" readonly="readonly">
		</c:when>
		<c:when test="${news.type==8 }">
		<input type="text"   value="娱乐" readonly="readonly">
		</c:when>
		<c:when test="${news.type==9 }">
		<input type="text"   value="健康" readonly="readonly">
		</c:when>
		</c:choose>
        </div>
        </div>
        ...
        <div class="am-form-group am-cf">
          ...
          <div class="you" style="height: 45px;">
            <input type="text"   value="<fmt:formatDate value="${news.createTime }" pattern="yyyy-MM-dd"/>" readonly="readonly">
          </div>
        </div>
