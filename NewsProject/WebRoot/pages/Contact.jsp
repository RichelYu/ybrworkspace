					...
					<div class="dropdown-menu">
						<div class="dropdown-inner">
							<ul class="list-unstyled">
								...
								<li><a href="${pageContext.request.contextPath }/news/selectByType?type=3">房产</a></li>
								<li><a href="${pageContext.request.contextPath }/news/selectByType?type=4">历史文化</a></li>
							</ul>
							<ul class="list-unstyled">
								<li><a href="${pageContext.request.contextPath }/news/selectByType?type=5">科技</a></li>
								<li><a href="${pageContext.request.contextPath }/news/selectByType?type=6">汽车</a></li>
								<li><a href="${pageContext.request.contextPath }/news/selectByType?type=7">房产</a></li>
								<li><a href="${pageContext.request.contextPath }/news/selectByType?type=8">体育</a></li>
							</ul>
						</div>
					</div>
				</li>
				...
				<div id="main-content" class="col-md-8">
					<div class="box">
						<center><div class="box-header">
							<h1 class="center">反馈</h1>
						</div></center>
						<div class="box-content">
							<div id="contact_form">
								<form name="form1" id="ff"  method="post" action="${pageContext.request.contextPath }/news/addContact">
									<label>
									<span>反馈标题:</span>
									<input type="text"  name="contactTitle" id="name" required>
									</label>
									<label>
									<span>联系邮箱:</span>
									...
									<label>
									<span>反馈内容:</span>
									<textarea name="contactContent" id="message"></textarea>
									</label>
